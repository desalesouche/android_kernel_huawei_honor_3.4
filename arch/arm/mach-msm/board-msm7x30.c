...
/* use pimc gpio 36 to enable the power of SD and gpio_21 to detect */
#ifdef CONFIG_HUAWEI_KERNEL
...
static struct regulator_bulk_data cyttsp_regs[] = {
	{ .supply = "ldo8",  .min_uV = 1780000, .max_uV = 1800000 },
	{ .supply = "ldo15", .min_uV = 3047000, .max_uV = 3100000 },
};
...
#endif
/*
 *the function touch_power used to control the tp's power
 */
#ifdef CONFIG_HUAWEI_KERNEL
 ...
 *so when the platform or the product changed please self self adapt
 */
